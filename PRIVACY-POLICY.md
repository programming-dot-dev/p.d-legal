...
- **Basic account information:** When creating an account on one of our services you may be asked to enter in a username and password. You may also enter additional information into optional fields such as: email, display name, profile picture, banner image, matrix ID, location, birthday, language, and biography. Currently [as of February 10, 2024], all of the additional custom fields are always listed publicly; your password and email is kept private.
